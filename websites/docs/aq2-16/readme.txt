SERVER/PLAYER DOCUMENTATION FOR ACTION 1.6 (UNOFFICIAL)


ACTION-SPECIFIC SERVER VARIABLES

ban: add up values to ban multiple weapons/items
     0       none
     1       knife
     2       mp5/10
     4       m3 shotgun
     ...
     32      sniper
     64      grenades
     128     pistol (actually just removes all ammo)
     256     lasersight
     512     slippers
     1024    bandolier
     2048    silencer
     ...
     If all weapons are banned except knives (value 254) then players 
     will start with 10 knives.
